...
- **[123 助手](./123-helper/)**（[Greasy Fork 主页](https://greasyfork.org/zh-CN/scripts/592236-123-%E5%8A%A9%E6%89%8B)）：增强 123 云盘网页端——全盘搜索、批量重命名、TMDB 媒体整理、文件清理、秒传工具箱（含二级秒传短链接）、批量分享与一键投稿（分享直投 + 秒传二级短链直投）、影库搜索转存。适用 123pan.com / .cn、123684 / 123865 / 123912 / 123635 等域名 + 公开分享页。
